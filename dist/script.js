...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"]('.page', '.next'); //экземпляр класс
  ...
  _createClass(VideoPlayer, [{
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          if (document.querySelector('iframe#frame')) {
            ...
            _this.createPlayer(path); // то создаем его
    ...
    value: function createPlayer(url) {
      this.player = new YT.Player('frame', {
        ...
        width: '100%',
        //ширина плеера
        videoId: "".concat(url) //сюда будем подгружать уникальный ID видео который на ютубе
    ...
    value: function render() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.showSlides(_this2.slideIndex); // при клике будет первый слайд
